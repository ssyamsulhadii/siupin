<div class="row">
    <div class="col-lg-6">
        ...
        <x-forms.input name="nama" label="Nama Lengkap <small class='text-danger'>Dengan Gelar</small>"
            item="{{ $pegawai->nama ?? '' }}"></x-forms.input>
        <x-forms.input name="nip" label="Nomor Induk Pegawai (NIP) <small class='text-danger'>Tanpa Spasi</small>"
            item="{{ $pegawai->nip ?? '' }}" type="number"></x-forms.input>
        <x-forms.input name="nkk" label="Nomor Kartu Keluarga (NKK)" item="{{ $pegawai->nkk ?? '' }}"
    ...
    <div class="col-lg-6">
        ...
        <x-forms.input name="unit_organisasi" label="Unit Organisasi"
            item="{{ $pegawai->unit_organisasi ?? '' }}"></x-forms.input>
        ...
        <x-forms.input name="telpon" label="Telpon" item="{{ $pegawai->telpon ?? '' }}"
            type="number"></x-forms.input>
